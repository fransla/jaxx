    ...
    if (highestAccountDict !== null) {
        ...
        if (amountDao <= highestAccountDict.balance) {
            ...
            for (var i = 0; i < this._sortedHighestAccountArray.length; i++) {
                ...
                var newTX = ethereumPouch.getPouchFoldImplementation()._buildEthereumTransaction(false, parseInt(this._sortedHighestAccountArray[i].ethereumNodeIndex), toAddress, 0, gasPrice, gasLimit, ethData, doNotSign);
